...
export default function Xintent() {
  ...
  return (
    ...
    <Layout title={'Twitter / X intent generator'} imgUrl={'https://salnet.xyz/xintent.png'} description = {'Generate Twitter or X intents with pre-filled text.'} xuser={'@salnetx'} weburl={'salnet.xyz/xintent'} summary={'twitter intent generator.'}>
    ...
    <div className="sm:mx-96 mx-6 mt-8">
      ...
      <header className="mb-12">
        ...
        <Image src="/x.png" alt="Twitter Logo" width={56} height={56} className="mr-2" />
      ...
      <main>
        ...
        {twitterIntentCode && (
          <div className="mt-4">
            ...
            <pre className="p-4 border rounded overflow-x-auto">
              {twitterIntentCode}
            </pre>
